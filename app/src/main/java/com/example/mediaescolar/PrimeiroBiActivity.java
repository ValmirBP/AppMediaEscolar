...
// Instanciando elementos do layout
        ...
        TextView txtMat1 = findViewById(R.id.txtMat4);
        TextView txtProv1 = findViewById(R.id.txtProv4);
        TextView txtTrab1 = findViewById(R.id.txtTrab4);
        Spinner s = findViewById(R.id.Spinner04);
        final EditText edtProv1 = findViewById(R.id.edtProv4);
        final EditText edtTrab1 = findViewById(R.id.edtTrab4);
        final TextView txtMed1 = findViewById(R.id.txtMed4);
        TextView txtSit1 = findViewById(R.id.txtSit4);
        final TextView txtMedFim1 = findViewById(R.id.txtMedFim4);
        final TextView txtSitFim1 = findViewById(R.id.txtSitFim3);
